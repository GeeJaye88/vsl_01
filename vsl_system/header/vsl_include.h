...
/*!
\file vsl_include.h
\brief vsl c & c++ header file includes
...
/*
	...
	Based on COM usage of HRESULT values.

	Check using SUCCEEDED(HRESULT value)
	------------------------------------
	SUCCESS_OK   : Success
	SUCCESS_FAULT: Success - but not everything is perfection.

	Check using FAILED(HRESULT value)
	------------------------------------
	ERROR_FAIL       : Unspecified error
	ERROR_UNEXPECTED : Unexpected condition

*/

#define SUCCESS_OK        S_OK
#define SUCCESS_FAULT     S_FALSE
#define ERROR_FAIL        E_FAIL
#define ERROR_UNEXPECTED  E_UNEXPECTED
